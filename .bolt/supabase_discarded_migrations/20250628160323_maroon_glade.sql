/*
# Simplify Registrations System

1. New Tables
  - `simple_registrations` - A simplified registration table with consolidated fields
  
2. Changes
  - Add new simplified fields to `events` table
  - Create functions and triggers for registration management
