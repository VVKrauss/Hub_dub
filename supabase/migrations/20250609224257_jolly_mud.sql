/*
  # Fix type mismatch in RPC functions
  
  1. Changes
    - Drop and recreate get_page_view_stats function with correct return types
  ...
  2. Purpose
    ...
    - Ensure COUNT(*) returns bigint instead of integer
    - Ensure AVG() returns numeric instead of integer
*/
