/*
  # Refactor Events Registration Data Structure
  
  1. Changes
    - Add new `registrations` JSONB column to events table
    - Migrate existing registration data to new structure
    - Update validation function to work with new structure
    
  2. Data Structure
    - `registrations` JSONB with:
      - `max_regs`: Maximum allowed registrations
      - `current`: Current total registrations
      - `current_adults`: Current adult registrations
      - `current_children`: Current child registrations
      - `reg_list`: Array of registration objects
*/
